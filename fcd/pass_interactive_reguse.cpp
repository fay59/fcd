...
namespace
{
	...
	struct InteractiveRegisterUse : public ModulePass
	{
		...
		void hackhack_systemVabi(const TargetInfo& x86Info, RegisterUse::mapped_type& table, bool returns, bool useStackPointer, unsigned argcount)
		{
			...
			table[x86Info.registerNamed("rax")] = returns ? AliasAnalysis::Mod : AliasAnalysis::NoModRef;
			...
			table[x86Info.registerNamed("rsp")] = useStackPointer ? AliasAnalysis::Ref : AliasAnalysis::NoModRef;
